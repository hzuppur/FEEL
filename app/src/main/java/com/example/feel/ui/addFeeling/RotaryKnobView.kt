...
// Modified to work on our purpose
class RotaryKnobView @JvmOverloads constructor(
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                maxValue = getInt(R.styleable.RotaryKnobView_maxValue, 360) + 1
                divider = 360f / (maxValue - minValue)
    ...
    private fun calculateAngle(x: Float, y: Float): Float {
        ...
        return -(Math.toDegrees(atan2(py, px))).toFloat() + 180
    }
